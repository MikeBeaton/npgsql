...
namespace Npgsql
{
    ...
    /// of <see cref="NpgsqlStandardDataReader"/> as are required to read from the cursors in the original
    /// result set.
    ///
    ...
    public sealed class NpgsqlDereferencingDataReader : NpgsqlDataReader
    {
        ...
        /// </remarks>
        internal NpgsqlDereferencingDataReader(NpgsqlStandardDataReader reader, CommandBehavior behavior, NpgsqlConnector connector) : base(connector)
        {
...
#region NextResult
...
#if TEST_WRAPPING_ONLY
                return FetchReader.NextResultAsync(cancellationToken);
#else
        ...
        {
#if TEST_WRAPPING_ONLY
            return async ? await FetchReader.ReadAsync(cancellationToken) : FetchReader.Read();
#else
            if (FetchReader != null)
            {
        ...
        internal override ValueTask<Stream> GetStreamInternal(int ordinal, bool async) =>
            FetchReader.GetStreamInternal(ordinal, async);
        ...
        public override object GetProviderSpecificValue(int ordinal) =>
            FetchReader.GetProviderSpecificValue(ordinal);
        ...
        public override Task<bool> IsDBNullAsync(int ordinal, CancellationToken cancellationToken) =>
            FetchReader.IsDBNullAsync(ordinal, cancellationToken);
...
#pragma warning restore CS1998
        ...
        public override Task<T> GetFieldValueAsync<T>(int ordinal, CancellationToken cancellationToken) =>
            FetchReader.GetFieldValueAsync<T>(ordinal, cancellationToken);
